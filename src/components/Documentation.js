                    ...
                    <div class="modal-content">
                      <div class="modal-body">
                        <div class="nav flex-sm-column flex-row">
                          <h1 className="get-started-title text-black">
                            Docsify.js
                          </h1>
                          Documentation on this site coming soon! Please refer
                          to our
                          <a
                            href="https://github.com/qlstico/parcelQL"
                            target="_blank"
                          >
                            Github
                          </a>
                          to read our docs for now!
                        </div>
                      </div>
