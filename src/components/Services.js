          ...
          <div className="row margin-t-30">
            <div className="col-lg-4 margin-t-20">
              <div className="services-box text-center hover-effect">
                ...
                <p className="padding-t-15 text-muted">
                  ...
                  visually appealing graph displaying your relations.
                </p>
              </div>
            </div>
            <div className="col-lg-4 margin-t-20">
            ...
            <div className="col-lg-4 margin-t-20">
              <div className="services-box text-center hover-effect">
                ...
                <p className="padding-t-15 text-muted">
                  Keeping everything simple, we made sure even the simplest
                  users can be accustomed to our app.
                </p>
              </div>
            </div>
          </div>
          <div className="row margin-t-30">
            <div className="col-lg-4 margin-t-20">
              <div className="services-box text-center hover-effect">
                ...
                <p className="padding-t-15 text-muted">
                  Using industry new technology such as React.js, we were able
                  to build this application without ever creating a page
                  refresh.
                </p>
              </div>
            </div>
            <div className="col-lg-4 margin-t-20">
              <div className="services-box text-center hover-effect">
                ...
                <p className="padding-t-15 text-muted">
                  Our product is developed with all users in mind. We currently
                  support Mac OSX, Windows & Debian Linux OS.
                </p>
              </div>
            </div>
            <div className="col-lg-4 margin-t-20">
              <div className="services-box text-center hover-effect">
                ...
                <p className="padding-t-15 text-muted">
                  Stay tuned for future release which support multiple
                  databases.
                </p>
              </div>
            </div>
